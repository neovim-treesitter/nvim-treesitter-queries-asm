# nvim-treesitter-queries-asm

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-asm/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-asm/actions/workflows/validate.yml)

Neovim tree-sitter queries for **asm**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-asm",
...
- [ ] Changes are scoped to `asm` — do not include files for other languages
